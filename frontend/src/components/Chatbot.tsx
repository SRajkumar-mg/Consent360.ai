  ...
  return (
    <>
      <button
        ...
        aria-label={open ? 'Close Consent360 AI Assistant' : 'Open Consent360 AI Assistant'}
        aria-expanded={open}
      >
        {open ? <IconX size={24} /> : (
      ...
      {open && (
        <div className="chatbot-panel" role="dialog" aria-label="Consent360 AI Assistant">
          ...
          <div className="chatbot-input-row">
            <textarea
              ...
              aria-label="Message to Consent360 AI Assistant"
              rows={1}
            />
            <button
