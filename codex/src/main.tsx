...
import App from './App'
import './App.css'
import { codexConsentAdapter } from './consentAdapter'
...
installGlobalConsentApi(codexConsentAdapter, ['necessary', 'functional', 'analytics', 'advertising'])
initConsentGate(codexConsentAdapter)
...
startTagScanMonitor(codexConsentAdapter)
