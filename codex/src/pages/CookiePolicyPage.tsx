...
export function CookiePolicyPage() {
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px', color: 'var(--text)' }}>
      <Link to="/" className="cookie-link">&larr; Back to Codex</Link>
      <h1 style={{ marginTop: 16 }}>Cookie Policy</h1>
      <p className="subtitle">How Codex uses cookies and similar technologies, and how your choices are enforced.</p>
