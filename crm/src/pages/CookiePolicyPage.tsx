...
export function CookiePolicyPage() {
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px' }}>
      <Link to="/" className="cookie-link">&larr; Back to JobHub</Link>
      <h1 style={{ marginTop: 16 }}>Cookie Policy</h1>
      <p className="subtitle">How JobHub uses cookies and similar technologies, and how your choices are enforced.</p>
      ...
      <div className="table-responsive" style={{ overflowX: 'auto' }}>
        <table className="table" style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {purposes.map((p) => (
              <tr key={p.code} style={{ borderTop: '1px solid var(--border, #e2e8f0)' }}>
