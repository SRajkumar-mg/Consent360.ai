...
class ConsentAction(BaseModel):
    ...
    consent_text: Optional[str] = None
    affirmative_action: Optional[str] = Field(default=None, description="R1-03: explicit affirmative action (ACCEPT, REJECT, WITHDRAW, CONFIRM, OTP_VERIFIED, CALL_CONFIRMED, DOCUMENT_SIGNED, CLICK, CHECKBOX, SUBMIT)")
    ...
    ip_address: str = ""
    notice_id: Optional[int] = Field(default=None, description="R4-001: consolidated notice ID for evidence linking")
