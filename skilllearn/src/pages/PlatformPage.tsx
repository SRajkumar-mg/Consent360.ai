...
import { consentContextApi, getErrorMessage } from '../api'
          ...
          <div className="sl-topbar-right">
            <button
              ...
              onClick={async () => {
                ...
                try {
                  const res = await consentContextApi.getConsentContext(state.customerId)
                  window.location.href = res.data.consent_portal_url
                } catch (e) {
                  console.error('Could not open the consent portal:', getErrorMessage(e))
                }
              }}
            >
